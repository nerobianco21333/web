...
var ikan = {
	...
	wxqrcode: function() {
		...
		$(".btn_wxgzh").click(function() {
            $("body").append('<div class="ikan_wrap"><div class="mac_pop_bg"></div><div class="ikan_content"><div class="ikan_content_hd"><h4 class="ikan_content_title">关注后微信观看</h4></div><div class="ikan_content_bd"><img class="info_img" src="' + wx_qrcode + '" alt="公众号二维码"><p>长按识别二维码或微信扫码关注</p><p>关注后回复片名即可</p><p>或微信搜索微信名：<span style="color: #f44336;">Ai云家<span></p></div><div class="ikan_content_ft"><a class="close_box" href="javascript:;">下次再说</a></div></div></div>');
