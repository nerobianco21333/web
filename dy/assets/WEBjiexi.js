...
class WEBjiexi{
   ...
   upload(e){
      ...
      $.ajax({
         url:'https://www.apivv.cn/api.php/douyin.jiexi',
         data: param,
         type: "post", 
         dataType: 'json',
         beforeSend: function () {
      ...
      $.ajax({
         ...
         success: function (data) {
            if(data.code == 1){
               ...
               <div class="mt-1">
                  <iframe border="0" src="${maccms.path}/addons/douyin/player.html?url=${encodeURIComponent(data.list.videourl)}" width="100%" height="610" marginWidth="0" frameSpacing="0" marginHeight="0" frameBorder="0" scrolling="no" vspale="0" noResize></iframe>
               </div>`;
